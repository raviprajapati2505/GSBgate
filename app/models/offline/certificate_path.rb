module Offline
  class CertificatePath < ApplicationRecord
    ...
    belongs_to :offline_project, class_name: 'Offline::Project', foreign_key: 'offline_certificate_path_id', inverse_of: :offline_certificate_paths

    #has_many :offline_scheme_mixes, dependent: :destroy
    has_many :offline_scheme_mixes, class_name: 'Offline::SchemeMix', foreign_key: 'offline_certificate_path_id',inverse_of: :offline_certificate_paths, dependent: :destroy
