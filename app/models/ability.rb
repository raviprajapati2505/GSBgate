class Ability
  ...
  def initialize(user)
    ...
    if user.system_admin?
      ...
      can :read, ProjectAuthorization, project: {project_authorizations: {user_id: user.id, role: ['cgp_project_manager', ProjectAuthorization.roles[:cgp_project_manager]]}}
      ...
      can :read, CertificationPath, project: {project_authorizations: {user_id: user.id, role: ['cgp_project_manager', ProjectAuthorization.roles[:cgp_project_manager]]}}
      ...
      can :read, SchemeMix, certification_path: {project: {project_authorizations: {user_id: user.id, role:  ['cgp_project_manager', ProjectAuthorization.roles[:cgp_project_manager]]}}}
      ...
      can :read, SchemeMixCriterion, scheme_mix: {certification_path: {project: {project_authorizations: {user_id: user.id, role:  ['cgp_project_manager', ProjectAuthorization.roles[:cgp_project_manager]]}}}}
      can :edit, SchemeMixCriterion, scheme_mix: {certification_path: {project: {project_authorizations: {user_id: user.id, role:  ['cgp_project_manager', ProjectAuthorization.roles[:cgp_project_manager]]}}}}
