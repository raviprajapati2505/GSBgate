    ...
    class OfflineProjects < Effective::Datatable
      ...
      datatable do
        ...
        col :certification_rating, 
            ...
            render partial: "/offline/certification_paths/rating.html.erb", locals: { ratings: Offline::CertificationPath.ratings.keys[rec.certification_rating], certification_type: rec.certificate_type }
        end.search do |collection, terms, column, index|
          terms_array = terms.split(",")
