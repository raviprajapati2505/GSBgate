# NOTE: we are overriding a 3th party controller, as we need to apply the cancan ability
module Effective
  class DatatablesController < ApplicationController
    ...
    def show
      ...
      # Note: this line was added to ensure we always take cancan abilities into account
