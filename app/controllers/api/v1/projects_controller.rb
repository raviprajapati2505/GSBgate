class Api::V1::ProjectsController < Api::ApiController
  ...
  def index
    ...
    query = Project.accessible_by(current_ability).joins(certification_paths: [:certificate])
                .where(certification_paths: {certification_path_status_id: [CertificationPathStatus::CERTIFIED, CertificationPathStatus::CERTIFICATE_IN_PROCESS]}, certificates: {certificate_type: Certificate::certificate_types[:operations_type], gsas_version: '2019'})
