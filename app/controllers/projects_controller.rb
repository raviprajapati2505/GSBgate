  ...
  private
    ...
    def project_params
      if current_user.system_admin?
        params.require(:project).permit(:code, :name, :description, :address, :location, :country, :construction_year, :latlng, :gross_area, :certified_area, :carpark_area, :project_site_area, :owner_id)
      else
        params.require(:project).permit(:code, :name, :description, :address, :location, :country, :construction_year, :latlng, :gross_area, :certified_area, :carpark_area, :project_site_area)
      end
    end
end
