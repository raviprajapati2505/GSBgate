  ...
  private
    ...
    def project_params
      if current_user.system_admin? || current_user.gsas_trust_admin?
        params.require(:project).permit(:name, :owner, :service_provider, :description, :address, :location, :country, :construction_year, :latlng, :gross_area, :certified_area, :carpark_area, :project_site_area, :terms_and_conditions_accepted, :location_plan_file, :site_plan_file, :design_brief_file, :project_narrative_file, :code)
      else
        params.require(:project).permit(:name, :owner, :service_provider, :description, :address, :location, :country, :construction_year, :latlng, :gross_area, :certified_area, :carpark_area, :project_site_area, :terms_and_conditions_accepted, :location_plan_file, :site_plan_file, :design_brief_file, :project_narrative_file)
      end
    end
end
