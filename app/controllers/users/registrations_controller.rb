...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def configure_account_update_params
    devise_parameter_sanitizer.permit(:account_update, keys: %i[name email username linkme_user gord_employee cgp_license cgp_license_expired employer_name service_provider_id active password password_confirmation current_password])
  end
