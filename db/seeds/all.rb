...
CertificationPathStatus.create!(id: CertificationPathStatus::SCREENING, name: 'Screening', past_name: 'Screened', description: 'The project team has completed all criteria. After the GORD certifier team has screened the criteria input, a GORD certifier manager will advance the status of the certification and provide screening comments.')
...
CertificationPathStatus.create!(id: CertificationPathStatus::VERIFYING, name: 'Verifying', past_name: 'Verified', description: 'The project team has completed all criteria. The GORD certifier team will now review all criteria input and set the the achieved scores of the criteria. After all criteria are approved or disapproved, a GORD certifier manager will advance the status of the certification.')
...
CertificationPathStatus.create!(id: CertificationPathStatus::VERIFYING_AFTER_APPEAL, name: 'Verifying after appeal', past_name: 'Verified after appeal', description: 'The project team has completed all criteria. The GORD certifier team will now review all criteria input and set the the achieved scores of the criteria. After all criteria are approved or disapproved, a GORD certifier manager will advance the status of the certification.')
CertificationPathStatus.create!(id: CertificationPathStatus::ACKNOWLEDGING_AFTER_APPEAL, name: 'Acknowledging after appeal', past_name: 'Acknowledged after appeal', description: 'The GORD certifier team has verified all criteria. After a project team manager acknowledges the achieved scores, he will advance the status of the certification.')
CertificationPathStatus.create!(id: CertificationPathStatus::APPROVING_BY_MANAGEMENT, name: 'Approving by management', past_name: 'Approved by management', description: 'The GORD certifier team approved this certification. The GORD management will now give their approval and advance the status of the certification.')
