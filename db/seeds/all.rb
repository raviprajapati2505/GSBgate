...
Criterion.create!(name: 'Accessibility', description: 'Encourage site selection near access to existing pedestrian and bicycle pathway networks, as well as intended users, in order to reduce vehicular transportation needs.', measurement: 'All projects will complete the Accessibility Calculator to determine the number of accessible entrances provided by the site, the length of the site perimeter, the number of average daily users the site is intended to serve, and the number of users within 480 meters of accessible entrances.\nAll projects will provide a site plan that will include an area around the site at least 480 meters on all sides. Include on the site plan: \n\n\u2022\tAll off-site pedestrian pathway networks, bicycle lanes, and bicycle trails within 480 meters\n\u2022\tAll site entrances, as defined by:\n\n\n1.\tAny intentional break in an impassible site boundary, designed to allow entrance\n2.\tThe first intersection of any outside road, pedestrian pathway, or bicycle trail with an open, passable site boundary\n\n\n\u2022\tAll site entrances which may be considered accessible, as defined by:\n\n\n1.\tEntrance is accessible if it intersects with an existing pedestrian pathway network extending at least 480 meters away from the site\n2.\tEntrance is accessible if it is located within 480 meters of a bicycle trail or dedicated bicycle lane network and includes bicycle racks', measurement_principle: 'All projects will be located in proximity to pedestrian and bicycle pathway access, as well as intended users.', category: Category.find_by_code('UC'))
Criterion.create!(name: 'Acoustic Conditions', description: 'Encourage selection of a project site with the least amount of noise exposure.', measurement: 'Option 1\nAll projects will use the Acoustic Conditions Calculator to determine the Day-Night Average Sound Level (DNL) exposure of the site. The project should demonstrate that the DNL is within an acceptable noise range through the use of existing noise contours or measurement methods that are based on guidelines of the U.S. Department of Housing and Urban Development, Office of Policy Development and Research.\nOption 2\nRefer to S9 Noise Pollution to identify as described in noise level pre-development (Pg. 241) measurement section.  \nUse the measured DNL for the project to obtain the score for this criteria.', measurement_principle: 'All projects will measure the average combined Day-Night noise level exposure of the site to traffic and aircraft noise.', category: Category.find_by_code('UC'))
Criterion.create!(name: 'Load on Local Traffic Conditions', description: 'Minimize the impact on local traffic conditions.', measurement: 'For all stand-alone buildings that are not part of a development, the project will complete the Load on Local Traffic Conditions Calculator to determine the traffic delay increase between pre-and post-development conditions. \nFor all buildings that are part of a development, the project will create a traffic study report that includes the following elements:\n\n\u2022\tAnalysis of existing traffic conditions\n\u2022\tCalculations for the delay time during peak hours at existing intersections, pre- and post-development, to estimate the added traffic load due to the project\n\u2022\tStrategies to mitigate the impact of increased delays due to the additional traffic load\n\u2022\tRevised calculations for the delay time, post-development, due to the implementation of the recommended strategies', measurement_principle: 'All projects will evaluate the effects of additional traffic loads due to new development on existing major arterials. All projects will analyze existing traffic conditions and calculate traffic delay time during peak hours (morning peak hours and afternoon peak hours) for pre- and post-development conditions. \n\xa0\nMOSQUES\nProject will analyze existing traffic conditions and calculate traffic delay time during the peak hours immediately following the Friday midday prayer for pre- and post-development conditions.', category: Category.find_by_code('UC'))
Criterion.create!(name: 'Private Transportation', description: 'Reduce the use of private transportation to ease the impact on traffic congestion and harmful emissions.', measurement: 'All projects will complete the Private Transportation Calculator. The calculator computes the percentage of users accommodated by alternative forms of transportation from the maximum building occupancy level, including staff and visitors.', measurement_principle: 'All projects will implement strategies to reduce the use of private transportation by providing support facilities for alternative forms of transportation.', category: Category.find_by_code('UC'))
Criterion.create!(name: 'Proximity to Amenities', description: 'Encourage development near pedestrian accessible amenities in order to reduce transportation needs.', measurement: 'All projects will complete the Proximity to Amenities Calculator and identify on a site map all the amenities that are located within short walking or driving distance from the proposed site, measured from the entry/exit point of the project. Amenities are broken into five categories according to usage type as follows:\nUse Categories\n\n\u2022\tPublic Services\n\u2022\tPlaces of Worship\n\u2022\tRetail - Services\n\u2022\tRetail - Goods\n\u2022\tRetail - Food\n\n\xa0\nAll amenities must fall within these categories. Projects will be scored on the total quantity of their amenities as well as the diversity between the use categories. \nThe Proximity to Amenities Calculator computes the criterion score based on the total number of amenities accessible to the project occupants within a 480 meters walking distance range. The number of amenities is weighted according to the walking distance in increasing increments in order to calculate a Performance Indicator.', measurement_principle: 'All projects will be located in proximity to various types of basic amenities with pedestrian access between the project and the services.', category: Category.find_by_code('UC'))
Criterion.create!(name: 'Proximity to Infrastructure', description: 'Minimize the amount of new infrastructure construction by selecting a site near available connections to existing infrastructure or seeking on-site \u201coff-grid\u201d solutions.', measurement: 'All projects will complete the Proximity to Infrastructure Calculator to determine the percentage of the infrastructure needs that can be met by existing, available infrastructure connections or through alternative on-site solutions. A type of infrastructure is considered to have an available connection if it is present on-site or at a neighboring property within 1 km and has or planned to have the capacity to support the infrastructure load of the building.', measurement_principle: 'All projects will minimize the amount of new infrastructure construction required to meet the needs of the building.', category: Category.find_by_code('UC'))
Criterion.create!(name: 'Public Transportation', description: 'Encourage development near access to effective public transportation networks in order to reduce private transportation needs.', measurement: 'All projects will complete the Public Transportation Calculator and identify on a site map the public transport stops within 480 meters of the proposed site. The distance is measured from the building\u2019s primary entry/exit point to the public transportation stop. \nAll projects will measure existing or planned public transportation stops that will be accessible at the time of the project\u2019s completion. Public transportation stops may only be counted once per each specific location, including stops that serve varying forms of public transportation or multiple directions of traffic. Public transportation modes may include buses, trams and trains, or rapid transit.', measurement_principle: 'All projects will be located in proximity to public transportation access.', category: Category.find_by_code('UC'))
Criterion.create!(name: 'Sewer & Waterway Contamination', description: 'Avoid contamination of waterways to reduce the burden on public treatment facilities.', measurement: 'All projects will develop a Sewer & Waterway Contamination Plan to collect and remove all toxic or harmful substances. Toxic or harmful substances include any solids, sludge, floating debris, oil, scum, or any substances associated with the industrial process.', measurement_principle: 'All projects will develop and implement a Sewer & Waterway Contamination Plan to collect and remove all harmful or toxic substances discharged from the site.', category: Category.find_by_code('UC'))
