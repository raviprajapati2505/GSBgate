...
sc_op_ex1 = SchemeCriterion.create!(scheme: Scheme.find_by_label('Operations'), criterion: Criterion.find_by_name('Energy consumption'), weight: 50, code: 'EX.1', score_description: "ENERGY SCORE", score_combination_type: 1, score_a: YAML.load("score_name: ENERGY USAGE\nscore_values: {-1: BAD, 3: GOOD}\n"))
sc_op_wx1 = SchemeCriterion.create!(scheme: Scheme.find_by_label('Operations'), criterion: Criterion.find_by_name('Water consumption'), weight: 50, code: 'WX.1', score_description: "WATER SCORE", score_combination_type: 2, score_a: YAML.load("score_name: WATER A\nscore_values: {-1: BAD, 3: GOOD\n}\n"), score_b: YAML.load("score_name: WATER B\nscore_values: {0: BAD, 1: GOOD\n}\n"))
