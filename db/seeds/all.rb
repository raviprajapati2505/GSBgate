...
req1 = Requirement.create!(reportable: ec1, label: 'Energy calculator')
req2 = Requirement.create!(reportable: wc1, label: 'Water calculator')
req3 = Requirement.create!(reportable: doc1, label: 'Specifications and documentation regarding the available infrastructure showing that the existing structures can handle the additional load from the building')
