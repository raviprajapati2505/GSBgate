...
BuildingType.create!(id: 1, name: 'Railways')
BuildingType.create!(id: 2, name: 'Sports')
BuildingType.create!(id: 3, name: 'Hotel')
BuildingType.create!(id: 4, name: 'Commercial')
BuildingType.create!(id: 5, name: 'Light Industry')
BuildingType.create!(id: 6, name: 'Education')
BuildingType.create!(id: 7, name: 'CORE + SHELL')
BuildingType.create!(id: 8, name: 'District & Infrastructure')
