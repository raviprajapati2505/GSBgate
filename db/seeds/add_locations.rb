...
location.list = ["Abu Hamour", "Ain Khalid", "Al Asiri", "Al Bidda", "Al Corniche", "Al Daayen", "Al Dafna", "Al Doha Al Jadeda", "Al Duhail", "Al Faroush", "Al Gharrafa", "Al Ghashmaia", "Al Ghouwariya", "Al Hilal", "Al Jumailiya", "Al Kabaan", "Al Karaana", "Al Khor", "Al Khoraitiyat", "Al Khulaifat", "Al Mamoura", "Al Manaseer", "Al Mashaf", "Al Messila", "Al Qassar", "Al Rayyan", "Al Sadd", "Al Shahaniya", "Al Shamal", "Al Soudan", "Al Thakhira", "Al Thumama", "Al Waab", "Al Wajba", "Al Wakrah", "Al Wukair", "Bin Mahmoud", "Bu Garn", "Doha Port", "Education City", "Hamad International Airport", "Hazm Al Markiya", "Industrial Area", "Katara", "Leabaib", "Learaig", "Lusail", "Lusail-Al Erkyah", "Lusail-Al Kharaej", "Lusail-Boulivard_COM", "Lusail-ECQ_1", "Lusail-Entertainment City", "Lusail-Entertainment Island", "Lusail-Fox Hills", "Lusail-Marina", "Lusail-North-_RES", "Lusail-Qetaifan", "Lusail-Qetaifan Islands", "Lusail-Stadium District", "Lusail-Waterfront_COM/ SEEF", "Lusail-Waterfront_RES", "Madinat Khalifa", "Mebaireek", "Mesaieed", "Mesaimeer", "Msheireb", "Muaither", "Muraikh", "Nuaija", "Old Airport", "Onaizah", "Qatar University", "Ras Bu Aboud", "Ras Bu Fontas", "Ras Laffan", "Rawdat Abal Heeran", "Rawdat Al Faras", "Rawdat Al Khail", "Rawdat Rashid", "Um Al Houl", "Umm Al Saneem", "Umm Ghuwailina", "Umm Salal", "Umm Salal Ali", "Wadi Al Banat", "Wadi Al Sail", "West Bay"]
location.save!
...
# Districts
district = District.find_or_initialize_by(country: "all", city: "all")
