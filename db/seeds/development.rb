...
Project.create!(name: 'Al Jazeera International', owner: User.find_by_email('owner@example.com'), client: User.find_by_email('enterprise@example.com'), certifier: User.find_by_email('certifier_pm@example.com'), address: 'Al Jazeera, Wadi Al Sail West, PO Box 23127', location: 'Doha', country: 'Qatar', latlng: 'POINT(51.498654 25.316083)')
Project.create!(name: 'Gulf Laboratory & X-Ray', owner: User.find_by_email('owner@example.com'), client: User.find_by_email('enterprise@example.com'), certifier: User.find_by_email('certifier_pm@example.com'), address: 'Gulf Laboratory & X-Ray, Al Kinana Street', location: 'Doha', country: 'Qatar', latlng: 'POINT(51.501958 25.277719)')
