...
Scheme.create!(label: 'Districts', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :design_stage))
Scheme.create!(label: 'Districts', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Parks', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :design_stage))
Scheme.create!(label: 'Parks', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Commercial', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :design_stage))
Scheme.create!(label: 'Commercial', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Core + Shell', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :design_stage))
Scheme.create!(label: 'Core + Shell', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Residential - Single', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :design_stage))
Scheme.create!(label: 'Residential - Single', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Residential - Group', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :design_stage))
Scheme.create!(label: 'Residential - Group', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Education', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :design_stage))
Scheme.create!(label: 'Education', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Mosques', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :design_stage))
Scheme.create!(label: 'Mosques', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Hotels', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :design_stage))
Scheme.create!(label: 'Hotels', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Light Industry', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :design_stage))
Scheme.create!(label: 'Light Industry', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Sports', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :design_stage))
Scheme.create!(label: 'Sports', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Railways', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :design_stage))
Scheme.create!(label: 'Railways', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Healthcare', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :design_stage))
Scheme.create!(label: 'Healthcare', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Construction', version: '3.0', certificate: Certificate.find_by(certificate_type: :construction_type, certificate_stage: :construction_stage))
Scheme.create!(label: 'Operations', version: '3.0', certificate: Certificate.find_by(certificate_type: :operations_type, certificate_stage: :operations_stage))
