...
Scheme.create!(label: 'Districts', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Parks', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :design_stage))
Scheme.create!(label: 'Parks', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Commercial', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :design_stage))
Scheme.create!(label: 'Commercial', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Core + Shell', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :design_stage))
Scheme.create!(label: 'Core + Shell', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Residential - Single', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :design_stage))
Scheme.create!(label: 'Residential - Single', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Residential - Group', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :design_stage))
Scheme.create!(label: 'Residential - Group', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Education', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :design_stage))
Scheme.create!(label: 'Education', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Mosques', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :design_stage))
Scheme.create!(label: 'Mosques', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Hotels', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :design_stage))
Scheme.create!(label: 'Hotels', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Light Industry', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :design_stage))
Scheme.create!(label: 'Light Industry', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Sports', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :design_stage))
Scheme.create!(label: 'Sports', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Railways', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :design_stage))
Scheme.create!(label: 'Railways', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Healthcare', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :design_stage))
Scheme.create!(label: 'Healthcare', version: '3.0', certificate: Certificate.find_by(certificate_type: :design_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Construction', version: '3.0', certificate: Certificate.find_by(certificate_type: :construction_type, assessment_stage: :construction_stage))
Scheme.create!(label: 'Operations', version: '3.0', certificate: Certificate.find_by(certificate_type: :operations_type, assessment_stage: :operations_stage))
# todo: Scheme.create!(label: 'Workers\' Accommodation', version: '3.0')
# todo: Scheme.create!(label: 'Bespoke Schemes', version: '3.0')

Score.create!(score: 0, description: 'Commissioning Plan does not demonstrate compliance.',                             criterion: Criterion.find_by_code('MO.1'))
Score.create!(score: 3, description: 'Commissioning Plan demonstrates compliance.',                                     criterion: Criterion.find_by_code('MO.1'))
Score.create!(score: 0, description: 'Organic Waste Management Plan does not demonstrate compliance.',                  criterion: Criterion.find_by_code('MO.2'))
Score.create!(score: 3, description: 'Organic Waste Management Plan demonstrates compliance.',                          criterion: Criterion.find_by_code('MO.2'))
Score.create!(score: 0, description: 'Recycling Management Plan does not demonstrate compliance.',                      criterion: Criterion.find_by_code('MO.3'))
Score.create!(score: 3, description: 'Recycling Management Plan demonstrates compliance.',                              criterion: Criterion.find_by_code('MO.3'))
Score.create!(score: 0, description: 'Leak Detection Plan does not demonstrate compliance.',                            criterion: Criterion.find_by_code('MO.4'))
Score.create!(score: 3, description: 'Leak Detection Plan demonstrates compliance.',                                    criterion: Criterion.find_by_code('MO.4'))
Score.create!(score: 0, description: 'Energy and Water Sub-metering Plan does not demonstrate compliance.',             criterion: Criterion.find_by_code('MO.5'))
Score.create!(score: 3, description: 'Energy and Water Sub-metering Plan demonstrates compliance.',                     criterion: Criterion.find_by_code('MO.5'))
Score.create!(score: 0, description: 'Automated Control System Plan does not demonstrate compliance.',                  criterion: Criterion.find_by_code('MO.6'))
Score.create!(score: 3, description: 'Automated Control System Plan demonstrates compliance.',                          criterion: Criterion.find_by_code('MO.6'))
Score.create!(score: 0, description: 'Hospitality Management Plan does not demonstrate compliance.',                    criterion: Criterion.find_by_code('MO.7'))
Score.create!(score: 3, description: 'Hospitality Management Plan demonstrates compliance.',                            criterion: Criterion.find_by_code('MO.7'))
Score.create!(score: 0, description: 'Sustainability Education and Awareness Plan does not demonstrate compliance.',    criterion: Criterion.find_by_code('MO.8'))
Score.create!(score: 3, description: 'Sustainability Education and Awareness Plan demonstrates compliance.',            criterion: Criterion.find_by_code('MO.8'))
Score.create!(score: 0, description: 'Legacy Plan does not demonstrate compliance.',                                    criterion: Criterion.find_by_code('MO.9'))
Score.create!(score: 3, description: 'Legacy Plan demonstrates compliance.',                                            criterion: Criterion.find_by_code('MO.9'))