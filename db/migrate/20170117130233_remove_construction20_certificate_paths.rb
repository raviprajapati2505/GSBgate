class RemoveConstruction20CertificatePaths < ActiveRecord::Migration
  def change
    ...
    SchemeMixCriterion.destroy_all(scheme_mix: scheme_mixes)
    ...
    SchemeCriterion.destroy_all(scheme_category: scheme_categories)
